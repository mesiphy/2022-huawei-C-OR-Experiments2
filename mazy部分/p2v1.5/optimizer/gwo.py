"""
灰狼优化算法 (Grey Wolf Optimizer) 核心模块 - P2 版本
"""
import numpy as np
import time
...
class GreyWolfOptimizer:
    """灰狼优化器：使用 GWO 算法优化车辆排序（P2 版本，4变量决策空间）"""
    
    def __init__(self, dimension: int = 14000, max_iterations: int = 200, 
        ...
        Args:
            dimension: 决策空间维度 (P2 默认 14000 = 3500步 * 4变量)
